...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'monotoring', loadChildren: './monotoring/monotoring.module#MonotoringModule' },
            { path: 'transaction', loadChildren: './transaction/transaction.module#TransactionModule' },
            { path: 'smartcontract', loadChildren: './smart-contract/smart-contract.module#SmartContractModule' }
        ]
    }
];
